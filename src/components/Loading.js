...
export default function Loading(){
    return (
        ...
        <g>
          <circle cx="73.3867" cy={50} r={4} fill="#e15b64">
          ...
          <circle cx="93.7867" cy={50} r={4} fill="#e15b64">
          ...
          <circle cx="53.5867" cy={50} r={4} fill="#e15b64">
          ...
          <path d="M50 50L20 50A30 30 0 0 0 80 50Z" fill="#f8b26a" transform="rotate(27.8801 50 50)">
          ...
          <path d="M50 50L20 50A30 30 0 0 1 80 50Z" fill="#f8b26a" transform="rotate(-27.8801 50 50)">
            <animateTransform attributeName="transform" type="rotate" repeatCount="indefinite" dur="1s" values="0 50 50;-45 50 50;0 50 50" keyTimes="0;0.5;1" />
          </path>
        </g>
      </svg>
